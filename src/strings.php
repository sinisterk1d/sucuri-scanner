...
__(
    'A powerful Web Application Firewall and <b>Intrusion Detection System</b> for any WordPress user and many other platforms. This page will help you to configure and monitor your site through the <b>Sucuri Firewall</b>. Once enabled, our firewall will act as a shield, protecting your site from attacks and preventing malware infections and reinfections. It will block SQL injection attempts, brute force attacks, XSS, RFI, backdoors and many other threats against your site.',
    'sucuri-scanner'
);
__(
    'Add your <a href="https://waf.sucuri.net/?settings&panel=api" target="_blank" rel="noopener">Firewall API key</a> in the form below to start communicating with the firewall API service.',
    'sucuri-scanner'
);
...
__(
    'We have not identified additional files, deleted files, or relevant changes to the core files in your WordPress installation. If you are experiencing other malware issues, please use a <a href="https://sucuri.net/website-security/malware-removal" target="_blank" rel="noopener">Server Side Scanner</a>.',
    'sucuri-scanner'
);
...
__(
    'We identified that some of your WordPress core files were modified. That might indicate a hack or a broken file on your installation. If you are experiencing other malware issues, please use a <a href="https://sucuri.net/website-security/malware-removal" target="_blank" rel="noopener">Server Side Scanner</a>.',
    'sucuri-scanner'
);
__('Review False Positives', 'sucuri-scanner');
__('WordPress Integrity (%%SUCURI.Integrity.ListCount%%)', 'sucuri-scanner');
__(
    'The Unix Diff Utility is enabled. You can click the files in the table to see the differences detected by the scanner. If you consider the differences to be harmless you can mark the file as fixed, otherwise it is advised to restore the original content immediately.',
    'sucuri-scanner'
);
...
__(
    'Check the box if your website is behind a known firewall service, this guarantees that the IP address of your visitors will be detected correctly for the security logs. You can change this later from the settings.',
    'sucuri-scanner'
);
...
__(
    'I have read and understand the <a target="_blank" href="https://sucuri.net/privacy">Privacy Policy</a>.',
    'sucuri-scanner'
);
__('Submit', 'sucuri-scanner');
...
__(
    'It seems that you disabled the email alerts for <b>new site content</b>, this panel is intended to provide a way to ignore specific events in your site and with that the alerts reported to your email. Since you have deactivated the <b>new site content</b> alerts, this panel will be disabled too.',
    'sucuri-scanner'
);
__(
    'This is a list of registered <a href="https://codex.wordpress.org/Post_Types" target="_blank" rel="noopener">Post Types</a>. You will receive an email alert when a custom page or post associated to any of these types is created or updated. If you don’t want to receive one or more of these alerts, feel free to uncheck the boxes in the table below. If you are receiving alerts for post types that are not listed in this table, it may be because there is an add-on that that is generating a custom post-type on runtime, you will have to find out by yourself what is the unique ID of that post-type and type it in the form below. The plugin will do its best to ignore these alerts as long as the unique ID is valid.',
    'sucuri-scanner'
);
...
__(
    'This is the directory where the plugin will store the security logs, the list of files marked as fixed in the core integrity tool, the cache for the malware scanner and 3rd-party plugin metadata. The plugin requires write permissions in this directory as well as the files contained in it. If you prefer to keep these files in a non-public directory <em>(one level up the document root)</em> please define a constant in the <em>"wp-config.php"</em> file named <em>"SUCURI_DATA_STORAGE"</em> with the absolute path to the new directory.',
    'sucuri-scanner'
);
__('Select All', 'sucuri-scanner');
__('File Path', 'sucuri-scanner');
...
__(
    'IP address discoverer will use DNS lookups to automatically detect if the website is behind the <a href="https://sucuri.net/website-firewall/" target="_blank" rel="noopener">Sucuri Firewall</a>, in which case it will modify the global server variable <em>Remote-Addr</em> to set the real IP of the website’s visitors. This check runs on every WordPress init action and that is why it may slow down your website as some hosting providers rely on slow DNS servers which makes the operation take more time than it should.',
    'sucuri-scanner'
);
...
__(
    '<b>WARNING!</b> This procedure can break your website. The reset will not affect the database nor the settings of each plugin, but depending on how they were written the reset action might break them. Be sure to create a backup of the plugins directory before the execution of this tool.',
    'sucuri-scanner'
);
__('Select All', 'sucuri-scanner');
__('Name', 'sucuri-scanner');
...
__(
    'This is a free website security scanner. Some types of malware and security issues cannot be detected by this scanner. If no issues are detected but you suspect a problem still exists, <a href="https://sucuri.net/website-security-platform/signup/" target="_blank" rel="noopener">sign up</a> for a complete and in depth website scan with malware cleanup.',
    'sucuri-scanner'
);
__(
...
__(
    'Log in to the <a href="https://dashboard.sucuri.net/login" target="_blank" rel="noopener">Sucuri Platform</a> dashboard for a complete scan of your website files and guaranteed malware removal. You can <a href="https://sucuri.net/website-security-platform/signup/" target="_blank" rel="noopener">sign up here</a> if you don&apos;t have an account yet.',
    'sucuri-scanner'
);
...
__(
    'The max-age setting tells your browser how long, in seconds, it can keep a copy of a web page before it needs to check for a new version. This is the basic setting needed to make caching work on most devices.',
    'sucuri-scanner'
);
__(
...
__('Here you can see all the cache options available.', 'sucuri-scanner');
__('Option', 'sucuri-scanner');
__('No options available', 'sucuri-scanner');
__('Cache Control Header', 'sucuri-scanner');
__('Enabled', 'sucuri-scanner');
__('Disabled', 'sucuri-scanner');
__('Mode:', 'sucuri-scanner');
__('Update', 'sucuri-scanner');
__('Edit', 'sucuri-scanner');
__(
    'Please enable site caching on your WAF to use these settings. If you are a Sucuri client and require assistance, please <a href="https://docs.sucuri.net/billing/how-do-i-open-a-general-support-ticket/" target="_blank" rel="noopener">{{create a ticket}}</a> and reach out to the firewall team for support.',
    'sucuri-scanner'
);
...
// 2fa-setup.snippet.tpl
__('Two-Factor Authentication', 'sucuri-scanner');
__('Two-factor authentication is not activated.', 'sucuri-scanner');
__('Please scan the QR, or input the key manually in your preferred 2FA app, and verify to activate it.', 'sucuri-scanner');
__('Please keep in mind that activating this option for all users will block them from being able to log-in until they activate their two-factor authentication. Each user will be prompted to activate upon their next login attempt.', 'sucuri-scanner');
__('Open your authenticator app on your phone.', 'sucuri-scanner');
__('Scan the QR code on the screen (or enter the key manually).', 'sucuri-scanner');
__('Enter the 6-digit code generated by the app.', 'sucuri-scanner');
__('Click "Setup" to activate.', 'sucuri-scanner');
__('Two-Factor Authentication is enabled for your account.', 'sucuri-scanner');
__('Enforce two-factor for all users', 'sucuri-scanner');
__('Setup', 'sucuri-scanner');

// 2fa-current-user-status.snippet.tpl
__('Two-Factor Authentication is already enabled for your account.', 'sucuri-scanner');
